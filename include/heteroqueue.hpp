#ifndef HETEROGENEOUS_HETEROQUEUE_HPP
#define HETEROGENEOUS_HETEROQUEUE_HPP
...
/*!
* \file heteroqueue.hpp
*
* This templated class replicates the features of an std::queue
...
namespace heterogeneous
{
    ...
    */
    template<typename... Types> class heteroqueue;
    /*!
    * \endcond
    */

    template<typename T, typename... Types>
    class heteroqueue<T, Types...>
    {
        // Friends
        template<typename... Args> friend class heteroqueue;
    ...
    public:
        ...
        template<typename U>
        using container_type = std::queue<U>;
        ...
        // std::queue uses lexographical comparison
        ...
        */
        bool operator==(const heteroqueue<value_type, Types...>& rhs)
        {
        ...
        */
        bool eq(const heteroqueue<value_type, Types...>& rhs)
        {
        ...
        * \brief Same as operator!=() but strictly enforces container element size matching.
        */
        bool ne(const heteroqueue<value_type, Types...>& rhs)
        {
            return !eq(rhs);
        }
        ...
        * \brief Same as operator<() but strictly enforces container element size matching.
        */
        bool lt(const heteroqueue<value_type, Types...>& rhs)
        {
        ...
        * \brief Same as operator>() but strictly enforces container element size matching.
        */
        bool gt(const heteroqueue<value_type, Types...>& rhs)
        {
        ...
        * \brief Same as operator<=() but strictly enforces container element size matching.
        */
        bool lte(const heteroqueue<value_type, Types...>& rhs)
        {
        ...
        * \brief Same as operator>=() but strictly enforces container element size matching.
        */
        bool gte(const heteroqueue<value_type, Types...>& rhs)
        {
    ...
    public:
        ...
        heteroqueue() : container_(new container_type<value_type>), next_(nullptr), counter_(nullptr)
        {
        ...
        ~heteroqueue() {}; //counter_ is deallocated in heteroqueue<>

    private:
        heteroqueue(size_t* pntr) : container_(new container_type<value_type>), next_(pntr), counter_(pntr)
    ...
    private:
     ...
     public:
        ...
        */
        void swap(heteroqueue<value_type, Types...>& x)
        {
    ...
    private:
        ...
        heteroqueue<Types...> next_;
        size_t* counter_;

        // Helper Methods
        heteroqueue<Types...>& next()
        {
            return next_;
        }

        const heteroqueue<Types...>& next() const
        {
            return next_;
        }
    ...
    */
    ...
    public:
        ...
        * \brief Returns true if == operator evaluates to true for each element in object.
        */
        bool operator==(const heteroqueue<value_type>& rhs)
        {
        ...
        * \brief Same as operator==() but strictly enforces container element size matching.
        */
        bool eq(const heteroqueue<value_type>& rhs)
        {
            // number of elements must match
            if ( static_cast<container_type<value_type>*>(container_)->size() != rhs.container<value_type, 0>()->size() ) return false;
            return *static_cast< container_type<value_type>* >(container_) == *rhs.container<value_type, 0>();
        ...
        * \brief Same as operator!=() but strictly enforces container element size matching.
        */
        bool ne(const heteroqueue<value_type>& rhs)
        {
            return !eq(rhs);
        }
        ...
        * \brief Same as operator<() but strictly enforces container element size matching.
        */
        bool lt(const heteroqueue<value_type>& rhs)
        {
            // if zero elements, cannot be less than
            if (static_cast<container_type<value_type>*>(container_)->size() == 0) return false;
        ...
        * \brief Same as operator>() but strictly enforces container element size matching.
        */
        bool gt(const heteroqueue<value_type>& rhs)
        {
            // if zero elements, cannot be greater than
            if (static_cast<container_type<value_type>*>(container_)->size() == 0) return false;
        ...
        * \brief Same as operator<=() but strictly enforces container element size matching.
        */
        bool lte(const heteroqueue<value_type>& rhs)
        {
            // if zero elements, cannot be less than, but can be equal!
        ...
        * \brief Same as operator>=() but strictly enforces container element size matching.
        */
        bool gte(const heteroqueue<value_type>& rhs)
        {
            // if zero elements, cannot be greater than, but can be equal!
        ...
        // Constructors & Destructors
        heteroqueue() : container_(new container_type<value_type>), counter_(nullptr)
        {
            counter_ = new size_t;
            *counter_ = 0;
        };
    ...
    private:
        heteroqueue(size_t* pntr) : container_(new container_type<value_type>), counter_(pntr)
        { /*this constructor does not allocate memory for counter_*/ };
    ...
    */
    ...
    bool operator==(const heteroqueue<Args_lhs...>& lhs, const heteroqueue<Args_rhs...>& rhs)
    {
...
#endif // HETEROGENEOUS_HETEROQUEUE_HPP