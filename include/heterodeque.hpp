...
namespace heterogeneous
{
    ...
    */
    ...
    private:
        void setEQUALTO(const heterodeque<T, Types...>& x)
        {
    ...
    public:
		...
		/*!
        * \brief Returns true if == operator evaluates to true for all elements in object.
        */
    ...
    public:
        ...
        heterodeque() : container_(new container_type<T>), next_(nullptr), counter_(nullptr)
        {
    ...
    private:
        heterodeque(size_t* pntr) : container_(new container_type<T>), next_(pntr), counter_(pntr)
    ...
    */
    // Entire heterodeque<> specialization marked private
    template<> class heterodeque<>
    {
        // Friends
        template<typename... Args> friend class heterodeque;
        ...
        heterodeque(size_t* pntr) : counter_(nullptr) {};

        // Operator Helpers
        void setEQUALTO(const heterodeque<>& x) {}

        // Relational Methods
        bool operator==(const heterodeque<>& rhs)
        { return true; }
		...
		bool eq(const heterodeque<>& rhs)
        { return true; }
		
		bool lt(const heterodeque<>& rhs)
        { return true; }
		
		bool gt(const heterodeque<>& rhs)
        { return true; }
		
		bool lte(const heterodeque<>& rhs)
        { return true; }
		
		bool gte(const heterodeque<>& rhs)
        { return true; }
