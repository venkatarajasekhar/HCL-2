...
int main()
{
    try
    {
        ...
        heterogeneous::heterodeque<double, std::string, int, int, double, std::string, int> hv;
        
        heterogeneous::heterodeque<double, std::string, int, int, double, std::string, int> rv;
